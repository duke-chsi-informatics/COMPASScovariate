...
do.call('rbind', 
  lapply(sim.out.list, FUN = function(sim) {
    ...
    mutate(
      CC.minus.C = tot.var.compass - tot.var.compass.cov,
      CC.prop.C = tot.var.compass.cov / tot.var.compass,
      sim.rep = sim$sim_rep,
      N.subjects = sim$I,
  ...
  summarize(N.rep = n(),
            Mean.CC.minus.C = mean(CC.minus.C),
            Mean.CC.prop.C = mean(CC.prop.C)
  )
```
