...
# iter = 1000 #Number of COMPASScovariate iterations per replicate
...
sim.pars <- expand.grid(I = c(30, 60, 100, 200),   #Number of subjects
                        K = c(4),        #Number of unique cell subsets
...
## Save Polyfunctional Scores

**TO DO:** Need to work out how to extract polyfunctionality scores from fit via .COMPASS.covariate

- Modify COMPASS function to use COMPASS.covariate?

```{r}
getCounts(sim.out.list[[1]]$sim.fit)

# PolyfunctionalityScore(sim.out.list[[1]]$sim.fit)
```
