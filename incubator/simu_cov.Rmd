...
library(foreach); library(doParallel); library(HMP); library(MultiRNG); library(MCMCpack); library(devtools)
...
```{r}
apply(sim2.fit$beta, MARGIN = c(1,2), FUN = function(x) median(x))
```
