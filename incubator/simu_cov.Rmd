...
pu.logmu = log(20)
p.logsd = 0.03
#Diff in means of lognormal a function of age with true intercepts and slopes below
ps.logmu.diff.beta = c(0.5, 0.5)
ps.logmu.diff.sd = 0.1 #Error term for relationship between shift in concentration and age
...
sim.pars <- expand.grid(I = c(300),#, 60, 100, 200),   #Number of subjects
