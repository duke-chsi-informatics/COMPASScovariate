...
antibodyDF_transf <- antibodyDF %>%
  mutate(logLuminex = ifelse(Luminex==0, 
                          log(Luminex + 0.001),
                          log(Luminex))) %>%
  #scale it
  mutate(Luminex = scale(logLuminex))
...
saveRDS(list(COMPASScovarobj = COMPASScovarobj, runTime = endtime-starttime),
          paste0("~/CHSI/PackageDev/COMPASScovariate/incubator/Frances/Data/rv144COMPASSorig20_seed100_new",postfix,".rds"))
...
COMPASS_covar <- function(flowDF_cut, X, postfix) {
  ...
  COMPASScovarobj <- .COMPASS.covariate(n_s=n_s, n_u=n_u,
                                         ...
                                         iterations = 20, replications = 7, X = X)
  endtime= Sys.time()

saveRDS(list(COMPASScovarobj = COMPASScovarobj, runTime = endtime-starttime),
          paste0("~/CHSI/PackageDev/COMPASScovariate/incubator/Frances/Data/rv144COMPASScovar20_seed100_new",postfix,".rds"))
...
COMPASSorig<- readRDS("~/CHSI/PackageDev/COMPASScovariate/incubator/Frances/Data/rv144COMPASSorig20_seed100_newcut.rds")$COMPASScovarobj$fit
...
COMPASScovarV2Lum<- readRDS("~/CHSI/PackageDev/COMPASScovariate/incubator/Frances/Data/rv144COMPASScovar20_seed100_newLum.rds")$COMPASScovarobj
...
COMPASSobj <- readRDS("~/CHSI/PackageDev/COMPASScovariate/incubator/Frances/Data/rv144COMPASSorig20_seed100_newcut.rds")$COMPASScovarobj
