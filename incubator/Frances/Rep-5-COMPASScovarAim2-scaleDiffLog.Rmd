...
COMPASScovarAim2_CD4_OG <- readRDS("~/CHSI/compass-covariate/data/archive/pp65Aim2diffsCOMPASScovar200000_seed100_more3forhalf_CD4_covar.rds")$pp65COMPASSAim2_diffs
...
```{r mean-gamma-cox-CD4, eval=FALSE}
...
```{r mean-gamma-cox-CD4covar, eval=FALSE}
#join mean gamma with demo data
